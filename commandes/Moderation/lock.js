...
module.exports.run = async(bot, message, args) => {
    ...
    if (!message.mentions.channels.first()) return message.lineReply(`${emojis.general.warning} Spécifiez le salon`)
    ...
    try {
        ...
        message.channel.send(`${emojis.general.lockedchannel} <#${Channel.id}> a bien était lock`)
    } catch (err) {
        console.log(err);
    }
