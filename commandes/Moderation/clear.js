        ...
        setTimeout(() => {
          ...
          if (!isNaN(message.content.split(' ')[1])) {
            ...
            await message.channel.bulkDelete(amount, true).then((_message) => {
              message.lineReply(`${emojis.general.yes} \`${_message.size}\` messages effacés.`).then((sent) => {
                setTimeout(function () {
                  sent.delete();
                }, 5000);
              });
            ...
            message.lineReply(`${emojis.general.warning} Mets un nombre sale aveugle!` ).then((sent) => {
              setTimeout(function () {
                sent.delete();
              }, 2500);
            });
