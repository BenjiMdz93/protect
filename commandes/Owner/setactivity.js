...
collector.on('collect', async (r , reaction) => { 
    if (r.emoji.name === '🎞️') {
        ...
        .catch(e => { return message.channel.send(`Erreur detectée.  **Plus d'informations:** \`🔻\` \`\`\`${e}\`\`\``); });
        ...
        message.channel.send(`Veuillez entrer l'activité que vous voulez definir pour votre bot`).then(mp => {
            ...
            .then(p => message.channel.send(`Vous avez défin le statut de votre bot en \`${stre.content}\` (**LISTENING**).`))
        .catch(e => { return message.channel.send(`Une erreur a été rencontré.  **Plus d'informations:** \`🔻\` \`\`\`${e}\`\`\``); });
        ...
        message.channel.send(`Veuillez entrer l'activité que vous voulez definir pour votre bot`).then(mp => {
            ...
            .then(p => message.channel.send(`Vous avez défini le statut de votre bot en \`${stree.content}\` (**GAMING**).`))
        .catch(e => { return message.channel.send(`Une erreur a été rencontré.  **Plus d'informations:** \`🔻\` \`\`\`${e}\`\`\``); });
            ...
            message.channel.send(`Vous avez supprimé l'activité de votre bot.`)
